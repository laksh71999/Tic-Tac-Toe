...
function clickedCell(cell) {
	...
	if (gameOver(board, COMP)) {
		...
		document.getElementById("imgClickAndChange").src = "S7F65kx.gif";
	}
	if (emptyCells(board).length == 0 && !gameOverAll(board)) {
		var msg = document.getElementById("message");
		msg.innerHTML = "Draw!";
		document.getElementById("imgClickAndChange").src = "https://64.media.tumblr.com/372a5cbf1308298e5a0b75d017951ca2/tumblr_ou80v7nJF11s9jnzyo2_500.gifv";
	}
...
function restartBnt(button) {
	if (button.value == "Start AI") {
		...
		document.getElementById("imgClickAndChange").src = "https://palanibalans.github.io/Gif/chestmicanimate.gif";
		var htmlBoard;
		var msg;
